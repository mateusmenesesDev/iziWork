...
const Collumn = ({ columnId, column, setColumns }: Iprops) => {
  ...
  return (
    <div className="flex flex-col">
      <ModalItem opened={opened} setOpened={setOpened} />
      <div className="flex w-full justify-between items-center p-5 group">
        ...
        <Menu shadow="md" width={200} position="bottom-end">
          ...
          <Menu.Dropdown className="hidden group-hover:block">
            ...
            <Menu.Item color="red" onClick={() => handleDeleteCollum(columnId)}>
              Delete
            </Menu.Item>
          </Menu.Dropdown>
        </Menu>
        ...
        {(provided, snapshot) => {
          return (
            ...
            >
              ...
              <div
                className="flex invisible group-one-hover:visible justify-center items-center w-full h-10 bg-[#D5D5D5] rounded-lg cursor-pointer hover:bg-[#C4C4C4]"
